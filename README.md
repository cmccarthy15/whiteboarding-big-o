...
- What is an algorithm? 
    specific set of steps that yield the same results 
    logical approach 
...
- How do we measure time? 
    with clocks ==> hours, minutes, seconds, etc. 
    re: computers maybe but milliseconds 
    instead of time ie minutes, seconds, etc. computations 




- What cases are we concerned with?
100000000000000 WORST CASE SCENARIO 
AS WE GET MORE AND MORE DATA, HOW DOES OUR ALGORITHM PERFORM? 
